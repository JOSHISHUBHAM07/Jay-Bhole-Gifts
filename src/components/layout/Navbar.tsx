...
import { ShoppingCart, Search, User, Menu, X, Gift, Sparkles } from "lucide-react";
    ...
    >
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 z-50">
          <button className="p-2.5 text-[#B5B5C0] hover:text-white hover:bg-white/5 rounded-xl transition-all hidden sm:block">
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <div className="flex items-center gap-3 mt-4 pt-4 border-t border-white/10">
              <button className="p-3 bg-white/5 rounded-xl text-[#B5B5C0] hover:text-white transition-colors">
                <Search className="w-5 h-5" />
              </button>
              <Link href="/profile" className="p-3 bg-white/5 rounded-xl text-[#B5B5C0] hover:text-white transition-colors" onClick={() => setMobileMenuOpen(false)}>
